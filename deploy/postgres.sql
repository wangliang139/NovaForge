...
CREATE TABLE IF NOT EXISTS assets (
    ...
    order_occupied DECIMAL(32, 18) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS ledgers (
    ...
    wallet_type public.wallet_type NOT NULL,
    total DECIMAL(32, 18),
    frozen DECIMAL(32, 18),
    total_delta DECIMAL(32, 18),
    frozen_delta DECIMAL(32, 18),
...
CREATE UNIQUE INDEX IF NOT EXISTS api_keys_key_lookup_active_idx ON api_keys (key_lookup) WHERE deleted_at IS NULL;
CREATE UNIQUE INDEX IF NOT EXISTS api_keys_user_name_active_idx ON api_keys (user_id, name) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS api_keys_user_id_active_idx ON api_keys (user_id) WHERE deleted_at IS NULL;
