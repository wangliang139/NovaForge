...
// P2 multi_bot 域源码以 multibot_* 文件名归组，便于检索与 Code Review；对外 API 仍在 *Entity 上。
// 相关文件：multibot_attribution_order.go、multibot_order_parent.go、multibot_fanout_synthetic.go、
// multibot_balance_update.go、multibot_symbol_leverage.go、multibot_order_lookup.go、multibot_order_attrib.go、multibot_obs.go。
